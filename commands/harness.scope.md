...
scope 完成后，按 `.harness/prompts/dashboard-updater.md` 中 Step 7 规则更新 `specs/{feature}/dashboard.html`：
- 填充 `#panel-scope` 面板：In-Scope / Out-of-Scope 双栏卡片（逐项列出所有模块/文件）
- harness.scope 节点侧边栏状态改为 `done` + `ok`
