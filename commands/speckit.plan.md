...
plan å®æåï¼æ?`.harness/prompts/dashboard-updater.md` ä¸?Step 3 è§åæ´æ° `{FEATURE_DIR}/dashboard.html`ï¼?
- å¡«å `#panel-plan` é¢æ¿ï¼ææ¯ç ç©¶å³ç­è¡¨ + Constitution åè§æ£æ¥è¡¨ + æ°æ®æ¨¡åæ¦è¦ + API å¥çº¦æ¸å
- plan èç¹ä¾§è¾¹æ ç¶ææ¹ä¸?`done` + `ok`
